...
export default function PackageList({ onNext }: PackageSelectionProps) {
    ...
    return (
        <Box sx={{
            // ✅ Pakai minHeight 100% agar bisa stretch tapi tetap bisa scroll
            minHeight: "100%",
            display: "flex",
            flexDirection: "column",
            gap: "16px",
            // ✅ Padding diperkecil karena Layout sudah punya padding 12px 24px
            paddingY: "12px",
        }}>
            ...
            {/* List — flex: 1 agar mengisi sisa space */}
                            ...
                            return (
                                ...
                                >
                                    <CardMedia
                                        component="img"
                                        height="140"
                                        image={`${BASE_URL}/uploads/${encodeURI(paketMenu.gambarUrl)}`}
                                        alt={paketMenu.nama}
                                    ...
                                    <CardContent sx={{ p: "12px" }}>
                                        ...
                                        <Typography sx={{ fontSize: "13px", color: "#ffbc0d", fontWeight: "bold" }}>
