...
describe("Cashier Role", () => {
    ...
    describe("TC-CA-009 Update pembayaran menjadi Paid", () => {
    ...
    describe("TC-CA-010 Void Order", () => {

        it("should void an existing order", async () => {
    ...
    describe("TC-CA-011 Akses Dashboard tanpa Login", () => {

        it("should reject access when token is not provided", () => {
    ...
    describe("TC-CA-011 Token Valid", () => {
    ...
    describe("TC-CA-011 Token Invalid", () => {
