...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    const menus = [
      ...
      { menu_id: '0ada7056-35c5-43ce-9788-a331f4a2f894', nama: 'Paket Hebat McSpaghetti Ayam (Krispy)', harga_awal: 40000, category_id: '5a6b7c8d-9e0f-1a2b-3c4d-5e6f7a8b9c0d', tipe_menu: 'Paket', gambarUrl: 'paket hebat/Paket HeBat McSpaghetti Ayam McD (Krispy).png' },
      { menu_id: '8e3c0544-b36e-4e04-91da-2eed13bb0f1d', nama: 'Paket Hebat McSpaghetti Ayam (Spicy)', harga_awal: 40000, category_id: '5a6b7c8d-9e0f-1a2b-3c4d-5e6f7a8b9c0d', tipe_menu: 'Paket', gambarUrl: 'paket hebat/Paket HeBat McSpaghetti Ayam McD (Spicy).png' },
